...
function Validate( event, handler )
{
	...
	for ( var i=0; i < n; i++ )
	{
		...
		if ( element.hasAttribute( "required" ) )
		{
			...
			purejavascript.validate.AddClass( element, "checked" );
...
purejavascript.validate = {}

purejavascript.validate.HasClass
=
...
purejavascript.validate.AddClass
=
function ( element, cls )
{
	if ( element && cls )
...
purejavascript.validate.RemoveClass
=
function ( element, cls )
{
	var classes = element.className;
